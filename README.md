...
<div align="center">
  <img src="./Preview/privew.gif" alt="Trackify Mobile App Preview" style="border-radius:   display: block; box-shadow: 0 10px 40px rgba(0,0,0,0.2); border: 8px solid #f5f5f5;">
</div>

*Experience the sleek purple and pink gradient UI of Trackify's mobile application*
